<template>
    <div>
      <navbar></navbar>
<div class="hero-wrap hero-wrap-2 img" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-start">
          <div class="col-md-12 text-center mb-5" data-aos="fade-down-left" data-aos-duration="1000">
          	<p class="breadcrumbs mb-0"><span class="mr-3"><router-link :to="'/'">Home <i class="ion-ios-arrow-forward"></i></router-link></span> <span>Hizmatga yollanish</span></p>
            <h1 class="mb-3">Hizmatga yollanish</h1>
          </div>
        </div>
      </div>
    </div>
